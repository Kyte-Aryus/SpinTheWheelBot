...
{
    public class RequireBigRedButtonEnabled : PreconditionAttribute
    {
        ...
        public override Task<PreconditionResult> CheckPermissionsAsync(ICommandContext context, CommandInfo command, IServiceProvider services)
        {
            ...
            {
                // If this command was executable
                if (managementService.IsBigRedButtonEnabled())
                {
                ...
                {
                    return Task.FromResult(PreconditionResult.FromError("Big Red Button is not enabled!"));
                }
            }
            else
            {
