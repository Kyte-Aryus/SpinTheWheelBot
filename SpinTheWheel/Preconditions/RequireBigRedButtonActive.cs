...
{
    public class RequireBigRedButtonActive : PreconditionAttribute
    {
        ...
        public override Task<PreconditionResult> CheckPermissionsAsync(ICommandContext context, CommandInfo command, IServiceProvider services)
        {
            ...
            {
                // If this command was executed by a bot admin
                if (managementService.IsBigRedButtonActive())
                {
                ...
                {
                    return Task.FromResult(PreconditionResult.FromError("Big Red Button is not active!"));
                }
            }
            else
            {
